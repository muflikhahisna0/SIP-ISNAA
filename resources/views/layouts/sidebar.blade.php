<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html">DigitalDev</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html">St</a>
        </div>
        <ul class="sidebar-menu">
            <li class="@if (Request::segment(1) == 'dashboard') active @endif"><a class="nav-link" href="{{ url('dashboard') }}"><i class="fas fa-layer-group"></i> <span>Dashboard</span></a></li>
            <li class="menu-header">Menu</li>
            <li class="nav-item dropdown @if (Request::segment(1) == 'konfigurasi') active @endif">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-cogs"></i> <span>Konfigurasi</span></a>
            ...
            <li class="nav-item dropdown @if (Request::segment(1) == 'master-data') active @endif">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-file-archive"></i> <span>Master Data</span></a>
                <ul class="dropdown-menu">
                    @can('akses')
            ...
            <li class="@if (Request::segment(1) == 'crud') active @endif"><a class="nav-link" href="{{ route('crud') }}"><i class="fas fa-server"></i> <span>Produk</span></a></li>
