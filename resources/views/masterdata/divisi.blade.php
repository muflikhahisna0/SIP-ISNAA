...
<div class="section-body">
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            @can('tambah_data')
            <div class="card">
                <div class=" row mb-1 ml-1 p-3">
                    <button class="btn btn-primary mr-2" data-toggle="modal" data-target="#modal-tambah">Tambah Data</button>
                    <!-- {{ SiteHelpers::cek_akses() }} -->
                    <button type="button" class="btn btn-danger mr-2" id="deleteAllSelectedRecords">Delete All</button>
                    <a href="{{ route('divisiexport') }}" class="btn btn-sm btn-success export mr-2"><i class="fas fa-file-excel">Export</i></a>
                    <a href="#" class="btn btn-sm btn-success import" data-toggle="modal" data-target="#modal-import"><i class="fas fa-file-upload">Import</i></a>
                </div>
            </div>
            @endcan
            <hr>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr id="sid{{$dt->id}}">
                                @can('tambah_data')
                                <th> <input type="checkbox" name="ids" id="checkBoxClass" value="{{$dt->id}}"></th>
                                @endcan
                                <th scope="row">{{ $no+1 }}</th>
                                <td>{{ $dt->nama }}</td>
                                @can('tambah_data')
                                <td>
                                    <a href="#" data-id="{{ $dt->id }}" class="btn btn-icon icon-left btn-success btn-edit">
                                        <i class="far fa-edit">Edit</i>
                                    </a>
                                    <a href="#" data-id="{{ $dt->id }}" class="btn btn-icon icon-left btn-danger swal-confirm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="modal-import">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('divisiimport') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
